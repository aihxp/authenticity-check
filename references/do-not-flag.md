...
humanizer repo must stay untouched. The restraint criteria are shared across
the pair on purpose: authenticity-check withholds flags against the same
guardrails humanizer withholds edits against.
