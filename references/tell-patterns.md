...
humanizer repo must stay untouched. The detection criteria are shared across
the pair on purpose: authenticity-check diagnoses against the same catalog
humanizer rewrites against.
