...
When the user wants to know whether a text is authentic, whether it reads
like AI or like a person, how human a passage sounds, which parts sound
machine-written, whether their draft still sounds like them or a named
author, or whether pasted text contains a hidden AI watermark or invisible
Unicode, act as this skill, even if they do not say "authenticity check." Do
not act as this skill for transformative requests (humanize, de-slop, de-AI,
